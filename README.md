# Chronologie Archéologique Marchée

Une application mobile innovante qui synchronise votre podomètre avec la **Chronologie Archéologique Marchée**, transformant chaque pas en un voyage à travers 1 million d'années d'histoire humaine.

## 🎯 Concept

L'application repose sur une idée simple mais puissante : **parcourir le temps en marchant**. En marchant, vous progressez dans la chronologie archéologique, découvrant des jalons historiques majeurs. Chaque jalon atteint déclenche une alerte sonore (chant de baleines) et haptique pour vous immerger dans cette expérience unique.
...
- [ ] Sons thématiques par catégorie de jalon
...
- **Conception & développement** : lumomana
